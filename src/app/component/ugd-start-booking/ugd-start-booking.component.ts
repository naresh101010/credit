...
@Component({
  selector: 'app-ugd-start-booking',
  templateUrl: './ugd-start-booking.component.html',
  styleUrls: ['./ugd-start-booking.component.css']
})
export class UgdStartBookingComponent implements OnInit {
      ...
      this.$bookingInfo
        ...
        .subscribe((response) => {
          ...
          if (response) {
            ...
            // console.log('this.totalpackages',Number(this.totalPackages))
            // console.log('this.Number(this.bookingInfoObj.totalPackageCount)',Number(this.bookingInfoObj.totalPackageCount))
            console.log('(Number(updatedOffering)', Number(updatedOffering))
            console.log('(Number(this.bookingInfoObj.serviceOfferingId)', Number(this.bookingInfoObj.serviceOfferingId))
            ...
            if ((Number(this.totalPackages) === Number(this.bookingInfoObj.totalPackageCount)) && (Number(updatedOffering) === Number(this.bookingInfoObj.serviceOfferingId))) {
              // this.fieldsetDisabled = true;
              console.log('inside fully rebooked')
            ...
            //   console.log('inside differ offering')
            //   if (!newWaybill) {
      ...
      .subscribe((response) => {
        if (response) {
          ...
          if (this.bookingInfoObj.waybillId && this.bookingInfoObj.rateCardId) {
            console.log('from hereeeeeeee', this.bookingInfoObj.rateCardId);
  ...
  getCommercialByRateCard(ratecard) {
    console.log('getCommercialByRateCard', ratecard)
    try {
      if (this.fieldsetDisabled == false) {
        if (this.RateCardList.length > 1) {
          this.spinner.show();
  ...
  getcommercialRateCardIdByAlias() {
    ...
    if (!this.RateCardList.length && this.bookingInfoObj.consignorId && !this.bookingInfoObj.rateCardId && !this.bookingInfoObj.commercialId && this.selectedProductCategoryCardList && this.bookingInfoObj.serviceOfferingId) {
      console.log('inside get commercial rate card by alias')
      if (this.selectedProductCategoryCardList.length == 1) {
