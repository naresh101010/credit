...
@Component({
  ...
  styleUrls: ['./view-start-booking.component.css']
})
export class ViewStartBookingComponent implements OnInit {
  ...
  saveBookingInfoDetails(){
    ...
    this.$bookingInfo.saveBookingFirstStep(this.bookingInfoObj).subscribe((response) => {
      if (response) {
...
saveConsignorConsigneeInfo(){
  ...
  openModeOfPaymentModel(type) {
    ...
    dialog.afterClosed().subscribe((response) => {
      ...
      if (response === true) {
        ...
        if (this.sfxObj && this.sfxObj.rateCardApplicableFlag == 0) {
    ...
    this.$bookingInfo
      ...
      .subscribe((response) => {
        if (response) {
          ...
          if ( this.sfxObj && this.sfxObj.msaCustId) {
        ...
        this.$bookingInfo.getSfxCode(sfxId, this.contractType, this.headerData).subscribe(
          (response) => {
            if (response) {
              ...
              //   }
              // }
              // this.getConsigneeByMsaCustId(this.sfxObj && this.sfxObj.msaCustId);
              if (this.sfxObj && this.sfxObj.rateCardApplicableFlag == 0) {
                // this.getAllConsigneeWithoutRateCard();
                // this.getAllConsigneerWithoutRateCard();
                this.getServiceOffering();
  ...
  openAddNewConsignee(lkpConsigntypeId) {
    ...
    if (this.fieldsetDisabled == false) {
      if(this.bookingInfoObj && this.bookingInfoObj.msaCustId){
  ...
  getConsigneerConsigneeByExsisting(type) {
    ...
    if (type == 1) {
      if (this.RateCardList.length) {
        this.getConsigneeByMsaCustId(this.sfxObj && this.sfxObj.msaCustId, type);
      } else {
