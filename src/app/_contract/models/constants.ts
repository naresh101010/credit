...
export class ErrorConstants {
  ...
  public static VAL_ERR_401	= 'PRC Code already exists'
  ...
  public static VAL_ERR_231	= 'SFDC Oppr Id is not available'
  public static VAL_ERR_532	 = 'MSA Account Id is not available'
...
map.set("VAL_ERR-231",ErrorConstants.VAL_ERR_231);
map.set("VAL_ERR-532",ErrorConstants.VAL_ERR_532);
