export class AppSetting {
  public static API_ENDPOINT = JSON.parse(sessionStorage.getItem("config")).associate_network.API_ENDPOINT;
  ...
  // associate_network
  // public static API_ENDPOINT ='http://9fd1f2f0-associate-ingress-94f7-1723126191.ap-south-1.elb.amazonaws.com/asscntrnwbff/';
