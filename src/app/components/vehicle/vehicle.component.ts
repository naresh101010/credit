...
export class VehicleComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.vehicleForm = this.fb.group({
      ...
      sfxFinFlag: [0, Validators.required],
      vendorMktFlag: [0, Validators.required],
      ...
      taxPaidFlag: [0, Validators.required],
      taxPaidDt: ['', Validators.required],
      taxPaidValidity: ['', Validators.required],
      nationalPermitFlag: [0, Validators.required],
      pollutionCheckFlag: [0, Validators.required],
      pollutionCheckDt: ['', Validators.required],
      pollutionValidity: ['', Validators.required],
      fitnessCheckFlag: [0, Validators.required],
      ...
      paintedLogoFlag: [0, Validators.required],
      bodyPaintDt: ['', Validators.required],
      vehicleAcFlag: [0, Validators.required],
      bodyAcFlag: [0, Validators.required],
      gpsEnabledFlag: [0, Validators.required],
      gpsDeviceNum: ['', Validators.required],
      gpsVendor: ['', Validators.required],
      fastTagFlag: [0, Validators.required],
